...
if [[ "$(install_codecs_test)" = "Installed" ]]; then
	...
	install_pkg faac faad2 gstreamer1 gstreamer-plugins-bad gstreamer-plugins-bad-free gstreamer-plugins-bad-nonfree gstreamer-plugins-base gstreamer-plugins-entrans gstreamer-plugins-espeak gstreamer-plugins-fc gstreamer-plugins-good gstreamer-plugins-good-extras gstreamer-plugins-ugly libdca libmad libmatroska xvidcore
fi
