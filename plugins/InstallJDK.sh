function I_F_InstallJDK # Install Oracle JDK
{
InstallJDK
}
...
function InstallJDK()
{
ShowFunc "Installing Oracle JDK"
if [ -e /usr/java/jdk1.7.0_03/bin/java ]; then
StatusMsg "Oracle JDK already installed"
else
file32="jdk-7u3-linux-i586.rpm"
get32="http://download.oracle.com/otn-pub/java/jdk/7u3-b04/jdk-7u3-linux-i586.rpm"
file64="jdk-7u3-linux-x64.rpm"
get64="http://download.oracle.com/otn-pub/java/jdk/7u3-b04/jdk-7u3-linux-x64.rpm"
ProcessPkg
fi
